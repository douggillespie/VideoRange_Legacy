...
//	public HidingPanel mDhp;
	...
	public VRTabPanelControl(VRControl vrControl) {
		...
		imageRibbonPanel = vrControl.getCurrentMethod().getRibbonPanel(); 
		vrSidePanel = new VRSidePanel(vrControl);
		
		imageSidePanels=new TabbedHidingPane();
		//create hiding panels
		imageControls=new VRImageEditPanel(vrControl);
	...
	public void changeMethod() {
		//change the ribbon
		changeRibbonPanel(vrControl.getCurrentMethod().getRibbonPanel()); 
		//change side panel
