...
//		}
	...
	private void setParams() {
		...
		if (vrLandMarkData.getPosition()!=null){
			...
			height.setText(String.format("%.1f", vrLandMarkData.getHeight()));
		}
		if (vrLandMarkData.getBearing() !=null) bearing.setText(String.format("%.1f", vrLandMarkData.getBearing()));
		if (vrLandMarkData.getPitch() !=null) pitch.setText(String.format("%.1f", vrLandMarkData.getPitch()));
		if (vrLandMarkData.getLatLongOrigin() !=null){
			measurementLat.setText(String.format("%.4f", vrLandMarkData.getLatLongOrigin().getLatitude()));
			measurementLong.setText(String.format("%.4f", vrLandMarkData.getLatLongOrigin().getLongitude()));
			measurementHeight.setText(String.format("%.1f", vrLandMarkData.getLatLongOrigin().getHeight()));
		}
		//if origin is not null then force the user to use that as their gps origin.
		if (origin!=null){
			measurementLat.setText(String.format("%.4f", origin.getLatitude()));
			measurementLong.setText(String.format("%.4f", origin.getLongitude()));
			measurementHeight.setText(String.format("%.1f", origin.getHeight()));
